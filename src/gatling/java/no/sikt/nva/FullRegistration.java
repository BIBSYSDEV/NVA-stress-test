...
public class FullRegistration extends Simulation {
  ...
  private String uri2 = "https://cognito-idp.eu-west-1.amazonaws.com";
  
  private String uri3 = "https://nva-resource-storage-282305091481.s3.eu-west-1.amazonaws.com/e945c267-8b04-4b38-aaef-8967278f7fb0";
  
  private String uri4 = "https://e2e.nva.aws.unit.no";
      ...
      http("request_0")
        ...
        .resources(
          ...
          http("request_2")
            .post(uri2 + "/")
            .headers(headers_2)
            .body(RawFileBody("no/sikt/nva/fullregistration/0002_request.dat")),
          http("request_3")
