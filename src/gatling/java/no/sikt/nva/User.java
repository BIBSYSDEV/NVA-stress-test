...
public class User {
    ...
    public static final ChainBuilder query =
        ...
        .options("/users-roles/institutions/users?institution=https%3A%2F%2F" + Config.API_DOMAIN + "%2Fcustomer%2F#{customerId}")
        .resources(http("QueryUsers")
            .get("/users-roles/institutions/users?institution=https%3A%2F%2F" + Config.API_DOMAIN + "%2Fcustomer%2F#{customerId}")
